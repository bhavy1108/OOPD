...
{     
 ...
 /****************************************
  *Default constructors: IMPORT:none EXPORT: address of ship object 
  ...
  ****************************************/
		...
		do
		{
			...
			switch(option)
			{
				...
				case 4:
					...
					break;
				default:
				System.out.println("Invalid Choice please choose option again");	
			}
		}
	...
	private void addSubmarine()
	{
	     ...
	     do
	     {
	      ...
	      Submarin objSub = new Submarin(inSerialNum,inYear, inHullType,inMaxDepth);
	      engine objEng = new engine(inFuelType,inCyclinder);
	      String object =(objSub+", "+ objEng);
	...
	private void addFighter()
	{
	     ...
	     do
	     {
	      ...
	      FighterJet objFJ = new FighterJet(inSerialNum,inYear, inordnance, inwingspan);
	      engine objEng = new engine(inFuelType,inCyclinder);
	      String object =(objFJ+", "+ objEng);
