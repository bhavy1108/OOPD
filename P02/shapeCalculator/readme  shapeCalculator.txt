Seenarain Bhavyattaa , worksheet 2 , Question 2

Date created: 11/03/2019

Date last modified: 11/03/2019

Purpose: The select any one of these shape( 1.Circle,2. Triangle , 3.Rectangle ) and calculate its area in (m ,cm, mm).

Files in project: shapeCalculator.java  shapeCalculator.class shapeCalculator_testResult.txt

Test Files: shapeCalculator.java  shapeCalculator.class shapeCalculator_testResult.txt

Functionality: The program enable the user to choose option (1. Circle 2.Rectangle 3.Triangle )  where the shape's areas are being calculated in(m ,cm ,mm) and if ever the user choose option 4 the latter will receive (4. Good Bye :( ) from the program. This program has been using IF -ELSEIF -ENDIF.
